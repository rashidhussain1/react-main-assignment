      ...
      <div className="allcourses_header">
        ...
        <div className="form_container">
            <div className="form_left">
                <img className="profile_pic" src="https://st2.depositphotos.com/2783505/8278/i/600/depositphotos_82784040-stock-photo-passport-picture-of-a-cool.jpg"/>
            </div>
            <div className="form_right">
                <div className="name">
                    <div className="display_name">
                        <p className="name_text">Display Name</p>
                        <input className="input_name" type="text" placeholder="Add placeholder text"></input>
                    </div>
                ...
                <div className="interest">
                    ...
                    <label className="label_text"> Designer</label><br/>
                    <input type="checkbox"  className="checkbox1" value="Designer"/>
                    <label className="label_text"> Developer</label><br/>
                    <input type="checkbox"  className="checkbox1" value="Designer"/>
                    <label className="label_text"> Project Manager</label><br/>
                    <input type="checkbox"  className="checkbox1" value="Designer"/>
                    <label className="label_text"> Sales</label><br/>
                </div>

                <div className="student_professional">
                    <p className="name_text">Are you a student or wworking professional</p>
                    <input type="radio" id="student" name="profession" value="student"/>
                    <label className="label_text">Student</label><br/>
                    <input type="radio" id="professional" name="profession" value="professional"/>
                    <label className="label_text">Professional</label><br/>
                </div>
                <div className="exp_box">
                    ...
                    <div className="expertise">
                        ...
                        <input type="radio" id="Backend" name="expertise" value="Backend"/>
                ...
                <div className="save_box">
                    <div>
                        <button className="button_save" type="button">
                        SAVE
                        </button>
                    </div>
                </div>
